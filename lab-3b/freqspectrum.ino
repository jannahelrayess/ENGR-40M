...
const byte ANODE_PINS[8] = {}; // TODO: copy from lab 2a
const byte CATHODE_PINS[8] = {}; // TODO: copy from lab 2a
const byte AUDIO_INPUT_PIN = TODO;  // TODO: set this to your chosen pin

void setup() {
  // TODO: COPY the LED pin setup from lab 2a
...
void display(byte pattern[8][8]) {
  // TODO - COPY THIS CODE from your Lab 2a code.
}
